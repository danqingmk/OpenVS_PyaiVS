...
def tvt_dl(X,Y,split_type='random',model_name='gcn',task_type='cla',file_name=None,model_dir=None,device ='cpu',difftasks=['activity']):
    ...
    def hyper_opt(hyper_paras):
        ...
        if model_name == 'gcn':
            ...
            model_file_name = '%s/%s_%s_%s_%s_%.6f_%s_%s.pth' % (model_dir, args['model'], split_type, task_type,
            ...
            model_file_name = '%s/%s_%s_%s_%s_%.6f_%s_%s_%s.pth' % (model_dir, args['model'], split_type, task_type,
                                                                    hyper_paras['l2'], hyper_paras['lr'],
            ...
            model_dir, args['model'], split_type, task_type,
            hyper_paras['l2'], hyper_paras['lr'],
...
def para_dl(X,Y,opt_res=None,split_type='random',model_name='gcn',task_type='cla',file_name=None,model_dir=None,device ='cpu',difftasks=None):
    ...
    if task_type == "cla":
        ...
        print(para_res.groupby(['split', 'type'])['rmse', 'mae', 'r2'].mean(),best_res)
        return  para_res.groupby(['split', 'type'])['rmse', 'mae', 'r2'].mean(),best_res
